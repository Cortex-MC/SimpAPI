...
public class CampfireRecipe extends Recipe {
    ...
    public CampfireRecipe(@NotNull ItemStack result, @NotNull Material input, float experience, int cookingTime) {
        this.result = result;
        this.input = input;
     ...
     */
    public org.bukkit.inventory.CampfireRecipe getRecipe(@NotNull String id) {
